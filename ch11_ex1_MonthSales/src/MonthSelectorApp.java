...
public class MonthSelectorApp {
	...
	public static void main(String[] args) {
		...
		String[] monthNames = { "Jan", "Feb", "March", "April", "May", "June", "July", "Aug", "Sept", "Oct", "Nov",
				"Dec" };
		double[] monthSales = { 100.00, 200.01, 300.02, 400.03, 500.04, 600.05, 700.06, 800.07, 900.08, 1000.09,
				1100.10, 1200.11 };
