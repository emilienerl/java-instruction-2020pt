...
public class InvoiceApp {
	...
	public static void main(String args[]) {
		...
		// new invoice with open constructor
	...
	public static void getLineItems(Invoice invoice) {
		...
		while (choice.equalsIgnoreCase("y")) {
			...
			// add a new line item and pass it into a new item
	...
	public static void displayInvoice(Invoice invoice) {
		...
		for (LineItem lineItem : invoice.getLineItems()) {
			...
			String s = product.getCode() + "\t" + product.getDescription() + "\t" + product.getPriceFormatted() + "\t"
					+ lineItem.getQuantity() + "\t" + lineItem.getTotalFormatted();
