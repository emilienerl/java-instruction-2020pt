...
public class MPGApp {
	...
	public static void main(String[] args) {
		...
		while (choice.equalsIgnoreCase("y")) {
			...
			// double mpg = miles / gallons;
			// mpg = (double) Math.round(mpg * 100) / 100;
			// long mpgRounded = Math.round(mpg);

			/*
			 * double mpg = miles / gallons; NumberFormat mpgFormatter =
			 * NumberFormat.getNumberInstance(); mpgFormatter.setMaximumFractionDigits(3);
			 * 
